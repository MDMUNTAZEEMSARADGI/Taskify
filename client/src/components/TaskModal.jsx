...
const TaskModal = ({ isOpen, onSave, onClose, onLogout, taskToEdit }) => {
        ...
        <div className="bg-white border border-purple-100 rounded-xl max-w-md w-full shadow-lg relative p-6 animate-fadeIn">
          ...
          <form onSubmit={handleSubmit} className=" space-y-4">
            ...
            <div>
              ...
              <div className=" flex items-center border border-purple-100 rounded-lg px-3 py-2.5 focus-within:ring-purple-500 focus-within:border-purple-500 focus-within:ring-2 transition-all duration-200">
                <input
                  type="text"
                  name="title"
                  required
