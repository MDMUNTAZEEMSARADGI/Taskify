...
import { Zap, Clock, Circle, TrendingUp } from "lucide-react";
              ...
              <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
                ...
                <div className=" grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                  ...
                  <StatCard
                    ...
                    icon={
                      <Circle className=" w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-500" />
                    }
                  />
                  <StatCard
                    ...
                    icon={
                      <Zap className="w-3 h-3.5 sm:w-4 sm:h-4 text-purple-500" />
                    }
                  />
                </div>
                {/*  */}
