...
const Profile = ({ setCurrentUser, onLogout }) => {
  ...
  useEffect(() => {
    ...
    if (!token) return toast.error("Unauthorized access. Please login first.");
      ...
      <div className=" min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          <div className=" flex items-center gap-4 mb-8">
            <div className=" w-16 h-16 rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-600 flex items-center justify-center text-white text-2xlfont-bold shadow-md">
            ...
            <section className={SECTION_WRAPPER}>
              ...
              <form onSubmit={changePassword} className=" space-y-4">
                ...
                <div className="mt-8 py-6 border-t border-purple-100 ">
                  ...
                  <button className={DANGER_BTN} onClick={LogOut}>
                    Log out
                  </button>
                </div>
              </form>
